...
(function () {
    ...
    upload_inp.addEventListener('change', async function () {
        // input type为file时，可以获取选中的文件信息
        console.log('BASE64', upload_inp.files);
        // file 是一个Blob对象
        let file = upload_inp.files[0],
            BASE64,
            data;
        ...
        // 添加按钮loading，表示元素的 class 属性的集合， add()、remove()、replace() 和 toggle() 方法修改其关联的 DOMTokenList
